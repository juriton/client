...
INSERT INTO client (id, first_name, last_name, user_name, email, address, country, user_id) VALUES (1, 'John', 'Smith', 'User1', 'john.smith@gmail.com', 'viru 1', 'estonia', '2');
INSERT INTO client (id, first_name, last_name, user_name, email, address, country, user_id) VALUES (2, 'John', 'Smith', 'User2', 'john.smith@gmail.com', 'viru 1', 'estonia', '3');
INSERT INTO client (id, first_name, last_name, user_name, email, address, country, user_id) VALUES (3, 'John', 'Smith', 'User3', 'john.smith@gmail.com', 'viru 1', 'estonia', '4');